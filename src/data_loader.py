...
def convert_date(df: pl.DataFrame, date_col: str = "CREATEDATE") -> pl.DataFrame:
...
def aggregate_inventory(df: pl.DataFrame, date_col: str = "DATE",
                    agg_col: str = "INVENTORYDELTA", mask_col: str = "POS_EVENT",
                    mask_type: str = "sold") -> pl.DataFrame:
